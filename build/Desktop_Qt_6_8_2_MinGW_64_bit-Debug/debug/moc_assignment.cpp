...
namespace {
struct qt_meta_tag_ZN10assignmentE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10assignmentE = QtMocHelpers::stringData(
    "assignment",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10assignmentE[] = {
...
Q_CONSTINIT const QMetaObject assignment::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_ZN10assignmentE.offsetsAndSizes,
    qt_meta_data_ZN10assignmentE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10assignmentE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<assignment, std::true_type>,
...
{
    auto *_t = static_cast<assignment *>(_o);
...
void *assignment::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10assignmentE.stringdata0))
